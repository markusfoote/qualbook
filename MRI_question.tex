...
\begin{equation}
	F_c = \gamma(B_0) + z \cdot G_ss = f_0 + \gamma \cdot z \cdot G_ss
\end{equation}
...
\begin{equation}
	\Delta F = \gamma \cdot G_ss \cdot \Delta z
\end{equation}

In common practice $\Delta F$ is held constant (on the order of 1000-2000 Hz) and slice thickness $\Delta z$ is varied by adjusting $G_ss$. Stronger gradients produce thinner slices, and vice versa.
