...
The most basic form of imaging is spin echo imaging where the transverse magnetization is re-phased with a 180$^\circ$ flip and then read out.  A basic pulse sequence for spin echo can be seen in figure \ref{fig:mri:spinecho}

\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{spinechodiag}	
	\end{center}
	\label{fig:mri:spinecho}
...
Here it is important to note that the signal is attenuated due to $T_2^*$ decay because the transverse magnetization is not being re-phased.
